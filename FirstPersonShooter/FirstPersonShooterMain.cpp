	...
	m_deviceResources(deviceResources), m_mouse(mouse), m_keyboard(keyboard)
{
	...
	m_world->m_entities.push_back(Entity(ResourceManager::Instance.getModel("AK47NoSubdiv_cw"), XMFLOAT3(5.f, 2.f, 2.f), XMFLOAT3(3.f, 2.f, 1.f)));
	...
	for (auto& action : actions)
	{
		if (action == Action::SHOOT)
		{
			...
			m_world->m_timedEntities.push_back(std::make_pair(
				Entity(ResourceManager::Instance.getModel("bullet"), 
