...
FirstPersonShooterXAMLMain::FirstPersonShooterXAMLMain(
	...
	m_deviceResources(deviceResources), m_mouse(mouse), m_keyboard(keyboard)
{
	...
	m_fpsTextRenderer = std::unique_ptr<FirstPersonShooter::SampleFpsTextRenderer>(new FirstPersonShooter::SampleFpsTextRenderer(m_deviceResources));
...
void FirstPersonShooterXAMLMain::CreateWindowSizeDependentResources() 
{
...
void FirstPersonShooterXAMLMain::StopRenderLoop()
{
	m_renderLoopWorker->Cancel();
}

// Updates the application state once per frame.
void FirstPersonShooterXAMLMain::Update() 
{
	ProcessInput();
...
void FirstPersonShooterXAMLMain::ProcessInput()
{
...
bool FirstPersonShooterXAMLMain::Render() 
{
...
bool FirstPersonShooterXAMLMain::ShouldClose()
{
	return m_gameState->GameFinished();
}

// Notifies renderers that device resources need to be released.
void FirstPersonShooterXAMLMain::OnDeviceLost()
{
